      ...
      <div style={styles.root}>
        ...
        <div className="row">
          ...
          <div className="col-xs-4 product-detail-info">
            ...
            <div className="row">
              <RaisedButton className="col-xs-5" primary={true} style={styles.raisedButton}><span className="letter">ADD TO BAG</span></RaisedButton>
              <RaisedButton className="col-xs-5" style={styles.raisedButton}>ADD TO WISHLIST</RaisedButton>
            </div>
